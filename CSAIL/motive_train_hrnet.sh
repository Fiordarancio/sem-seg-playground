...
# Using:
#   hrnet - c1
# as models to train on the motive dataset. Default values used for
...
# by command line. 
# Logs are arranged in increasing number x of experiments.
#
# Usage:
#   $ ./motive_train_hrnet.sh [|& tee logs/mtrainx.txt]
#---------------------------------------------------------------------------

set -e

echo "Motive training HRNET - $(date)"
echo "--------------"
echo "Configuring..."
# Model names
DATASET=motive
...
GPUS=0,1
echo "Passed argument --gpus ${GPUS}"
