...
TRAIN_SPLIT="train_spade"
EVAL_SPLIT="val_spade"
...
echo "------------------------------"
echo "Evaluation termined on $(date)"
...
echo "------------------------------------------------"
echo "Training and evalation completed (not exported)."

# DEBUG NOTE: While evaluating on ADE, installing tensorflow 
# and tensorflow-gpu 1.7.0 seems to solve the problem with sizes.
# This solution appears in issue #521 of matterport/Mask_RCNN
# and in issue #9870 of keras-team/keras. They claim the 
# problem is into input labels, and newer versions of tensorflow
# have managed it better. Though, we MUST verify that new 
# experiments will continue working with this version!!!