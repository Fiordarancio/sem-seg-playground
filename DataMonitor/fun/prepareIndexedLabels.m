function prepareIndexedLabels(labInDir, labOutDir, indexMap)
...
%   - indexMap: usually a pixelLabelIDs cell array, used for understanding
%               how each pixel must be interpreted.
